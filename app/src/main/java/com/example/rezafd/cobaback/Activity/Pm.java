...
public class Pm extends BaseActivity {
    EditText Nama,Waktu,Tempat;
    Button btnsave;
    ProgressDialog pg;
    TextView nrp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Waktu=(EditText) findViewById(R.id.input_waktu_kegiatan);
        Tempat=(EditText) findViewById(R.id.input_tempatpm);
        btnsave=(Button) findViewById(R.id.btn_savepm);
            ...
            public void onClick(View view) {
                ...
                send.enqueue(new Callback<ResponsModel>() {
                    ...
                    public void onResponse(Call<ResponsModel> call, Response<ResponsModel> response) {
                        ...
                        if (kode == 1) {
                            Toast.makeText(Pm.this, "Data Berhasil Disimpan", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(Pm.this, "Data Gagal Ditambah", Toast.LENGTH_SHORT).show();
                        }
                    }
